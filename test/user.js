        ...
        it('it should GET all the users', (done) => {
            chai
                ...
                .end((err, res) => {
                    ...
                    res.body.docs[0].statusPayment.should.be.a('boolean')
                    done()
                })
        })
        ...
        it('it should POST a user', (done) => {
            chai
                ...
                .end((err, res) => {
                    ...
                    res.body.statusPayment.should.be.a('boolean')
        ...
        it('it should GET a user by the given id', (done) => {
            ...
            chai
                ...
                .end((error, res) => {
                    ...
                    res.body.should.include.keys('id', 'name', 'lastname', 'roleId', 'roleU', 'userEX', 'email', 'skills', 'preferences', 'instagram', 'facebook', 'linkedin', 'professions', 'languages', 'stripeCustomerId', 'updatedAt', 'createdAt')
