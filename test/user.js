        ...
        it('it should GET a user by the given id', (done) => {
            ...
            chai
                ...
                .end((error, res) => {
                    ...
                    res.body.should.include.keys('id', 'name', 'lastname', 'roleId', 'roleU', 'email', 'skills', 'preferences', 'instagram', 'facebook', 'linkedin', 'professions', 'languages', 'updatedAt', 'createdAt')
